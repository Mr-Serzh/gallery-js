...
lightbox.insertAdjacentHTML(
  'beforeend',
  "<button type='button' class='lightbox__button button-left' data-action='show-left'></button>",
);
lightbox.insertAdjacentHTML(
  'beforeend',
  "<button type='button' class='lightbox__button button-right' data-action='show-right'></button>",
);
const btnLeft = document.querySelector(
  ".js-lightbox button[data-action='show-left']",
);
const btnRight = document.querySelector(
  ".js-lightbox button[data-action='show-right']",
);
